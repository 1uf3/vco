...
N 520 830 520 850 {lab=#net2}
N 190 830 190 850 {lab=#net2}
N -140 830 -140 850 {lab=#net2}
N 480 850 480 870 {lab=#net2}
N 810 850 810 870 {lab=#net2}
...
N -180 850 -180 870 {lab=#net2}
N 150 850 150 870 {lab=#net2}
...
N -570 890 -540 890 {lab=#net2}
N -540 850 -540 890 {lab=#net2}
N -540 850 810 850 {lab=#net2}
...
C {devices/isource.sym} -570 850 0 0 {name=I0 value=10u}
